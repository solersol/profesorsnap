  ...
  return (
    <section id="about" className="w-full flex flex-col lg:flex-row justify-center items-center min-h-screen gap-10 px-5 pt-0 mt-0 pb-0 mb-0">
      <div className="lg:w-7/12 p-4">
        <h1 className="font-anton text-[50px] mb-4">WHO's $SNAP</h1>
        <h2 className="font-anton text-[30px] mb-4">
          Professor $SNAP is an OG teacher in the Solana space—who do you think taught everything to the boys' club?<br/>
          <br/>This is where it all began. $SNAP has stepped back into the picture after retiring, needing to make ends meet. <br/>He knows everyone's secrets, but especially $BRETT's...<br/><br/>
